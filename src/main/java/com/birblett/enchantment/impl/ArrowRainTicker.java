...
public class ArrowRainTicker extends Ticker {

    public static ID<ArrowRainTicker> ID = new ID<>("arrow_rain");
    ...
    private ArrowRainTicker(LivingEntity entity, ServerWorld world, Vec3d target, ItemStack weaponStack, ItemStack projectileStack, Type type) {
        super(type);
        this.owner = entity;
        this.world = world;
        this.target = target;
        ...
        this.ticks = 11;
        this.ticksDelayed = projectileStack != null && projectileStack.getItem() instanceof FireworkRocketItem ? 3 : 2;
    }

    public ArrowRainTicker(ItemStack weaponStack, ItemStack projectileStack) {
        this(null, null, null, weaponStack, projectileStack, Type.DIRECT);
    }

    public ArrowRainTicker(ProjectileEntity entity, Vec3d target) {
        this(null, null, target, null, null, Type.SUMMON);
        this.entity = entity;
    }

    public ArrowRainTicker(LivingEntity entity, ServerWorld world, Vec3d target, ItemStack weaponStack, ItemStack projectileStack) {
