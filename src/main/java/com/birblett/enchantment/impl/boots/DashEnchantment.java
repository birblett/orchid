...
public class DashEnchantment extends OrchidEnchantWrapper {

    public DashEnchantment(String id, int processPriority, TagKey<Item> supportedItems, int weight, int maxLevel,
